...
export const INITIAL_INTERACTIONS = [
  {
    ...
    customerName: "Rahul Sharma",
    type: "Service Call",
    subject: "Keyboard replacement follow-up",
    description: "Customer was contacted regarding the keyboard replacement status.",
    date: "16 Aug 2026",
    status: "Completed",
    channel: "Phone",
    handledBy: "Sameer Verma",
  },
  {
    id: "INT-1002",
    customerId: "CUST-002",
    customerName: "Priya Kapoor",
    type: "Email",
    subject: "Battery issue update",
    description: "Customer was informed that battery diagnostics are required.",
    date: "17 Aug 2026",
    status: "Pending",
    channel: "Email",
    handledBy: "Aman Gupta",
  },
  {
    id: "INT-1003",
    customerId: "CUST-003",
    customerName: "Amit Patel",
    type: "Service Call",
    subject: "Screen flickering complaint",
    description: "Customer was contacted regarding the screen flickering issue.",
    date: "15 Aug 2026",
    status: "Completed",
    channel: "Phone",
    handledBy: "Aman Gupta",
  },
  {
    ...
    customerName: "Sneha Desai",
    type: "Email",
    subject: "Warranty repair confirmation",
    description: "Customer was notified that the RAM replacement was completed under warranty.",
    date: "14 Aug 2026",
    status: "Completed",
    channel: "Email",
    handledBy: "Sameer Verma",
  },
  {
    ...
    customerName: "Vikram Singh",
    type: "Follow-up",
    subject: "Warranty status follow-up",
    description: "Follow-up regarding the expired warranty and available service options.",
    date: "13 Aug 2026",
    status: "Pending",
    channel: "Phone",
    handledBy: "Support Team",
  },
];
